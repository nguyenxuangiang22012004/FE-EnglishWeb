...
| [`schools`](../resources/schools.md) | `show` | `destroy`, `export`, `import`, `index`, `restore`, `store`, `update` |
...
| [`users`](../resources/users.md) | `show`, `store`, `update` | `destroy`, `export`, `import`, `index` |
